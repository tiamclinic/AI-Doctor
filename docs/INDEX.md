...
| 13  | [ドクター共通テンプレ（廃止済み）](./13-doctor-content-model-api.md)    | §4.9.2   | 高     | 廃止済み   | 09         |
| 14  | [ドクター共通テンプレ管理画面（廃止済み）](./14-doctor-admin-cms.md)    | §4.9.2   | 中     | 廃止済み   | 13         |
| 15  | [結果画面 v0.3.2（個別ノート併用表示 + ドクター追記 CTA）](./15-result-doctor-merged-display.md) | §4.9.3 §4.9.6 §5.2.1 | 高 | 完了 | 11, 19, 21, 22 |
| 16  | [診断レポート印刷／PDF](./16-report-print-pdf.md)                       | §4.9.3   | 中     | 完了       | 15         |
...
| 20  | [管理画面: 診断一覧（/admin/diagnoses）](./20-admin-diagnoses-list.md) | F-09 §4.9.6（副フロー） | 中 | 完了 | 19         |
...
| 23  | [共通テンプレ層のサンセット（T-13/T-14 廃止）](./23-deprecate-doctor-content.md) | §4.9.2 注記 | 中 | 完了 | 15, 21     |
...
- 完了: 18 / 24（T-00〜T-09, T-11, T-12, T-15, T-18, T-19, T-20, T-21, T-22）
- 進行中: 1 / 24（T-10）
- 廃止予定: 2 / 24（T-13, T-14。コード資産は T-15 / T-19〜T-22 で流用）
- 仕様変更: 0 / 24（T-15 は v0.3.2 仕様で完了）
- F-09 関連新規: 5 / 24（T-19〜T-23）
- v0.3.2 接客中フロー成立: コア + 副フロー（診断一覧）完了（残: T-23 旧 API 撤去・T-16 印刷など）
